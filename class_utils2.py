...
class replay_memory():
    ...
    def reload_buffer(self, old_buffer):
        self.buffer = old_buffer
        self.buffer_idx = len(self.buffer) % self.max_buffer_size
...
class ddqn_agent(object):
    ...
    def reload_agent(self):
        self.q_eval = keras.models.load_model('C:\\Users\\alexa\\OneDrive\\Documents\\GitHub\\CM30359-2022-CW\\q_eval_DDQN_2.h5')
        self.q_target = keras.models.load_model('C:\\Users\\alexa\\OneDrive\\Documents\\GitHub\\CM30359-2022-CW\\q_target_DDQN_2.h5')

    def save_vals(self):
        self.q_eval.save('C:\\Users\\alexa\\OneDrive\\Documents\\GitHub\\CM30359-2022-CW\\q_eval_DDQN_untrained.h5')
        self.q_target.save('C:\\Users\\alexa\\OneDrive\\Documents\\GitHub\\CM30359-2022-CW\\q_target_DDQN_untrained.h5')
    ...
    def calculate(self):
        ...
        if(flag == False): #Memory Smaller than Batch Size
            ...
            q_action_select = self.q_eval.predict(new_state, verbose=0)  #pass in a state and network returns array with actions and their pred value
            q_max_action = np.argmax(q_action_select, axis=1) #e.g. [0.5, 0.2, 0.3, 0.7] then takes index of the best action, so in this      case it will return 3. as 0.7 is at index 3. 
